# RBX ST — Telegram-бот магазина аккаунтов и товаров

Бот продаёт товары из каталога сайта (аккаунты и цифровые товары): просмотр каталога, покупка с баланса, мгновенная выдача, история покупок, пополнение баланса. Robux продаёт **отдельный** бот. Баланс и привязка — общие с сайтом.

## Что умеет

**Для пользователей:**
- 🛒 Каталог по категориям → товар → покупка в один клик
- 🔐 Мгновенная выдача (логин/пароль/код) сразу после оплаты с баланса
- 💰 Реальный баланс с сайта; пополнение: CryptoBot, Telegram Stars ⭐, карта/СБП (Platega)
- 📋 История покупок
- 👤 Профиль: ID, email, статус Premium
- 🔗 Привязка аккаунта по 6-значному коду (без пароля)

**Для админов:**
- 📊 Свежие заказы по всем юзерам
- 🔍 Поиск пользователя по нику / email / ID
- ⭐ Звёздный баланс бота (`/stars`) + последние операции
